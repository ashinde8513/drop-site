...
- [x] Add canonical event/venue/artist pages from the real catalog — ready 2026-08-02 on `codex/entity-seo-venue-events-20260802`: stable UUID-backed readable paths, server-rendered lifecycle-aware metadata/JSON-LD, fail-closed index eligibility, a quality-filtered live entity sitemap, and full-catalog venue/artist pagination. Thin aggregates remain directly accessible with `noindex, follow`; ticket URLs never imply availability. No fabricated listings.
