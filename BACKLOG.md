...
- [ ] Deliver the combined Facebook Login and Phase 2 share-attribution website candidate through PR #92. Preserve validated first-touch referral data across password/email/OAuth signup without adding Meta permissions; keep the shared referral migration and live account canary separately gated.
