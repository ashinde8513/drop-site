...
- [x] Make verified phone mandatory for standalone website accounts — live 2026-08-12 through PR #81 / merge `fa695ff581e991bb2fa2e3e7c42a219b7f57f793`: explicit compatibility attestation routes every auth provider into no-skip OTP proof; recovery/sign-out/deletion remain reachable; exact-main workflow `31670064544` passed 7 Node + 160 Playwright checks and deployed byte-identical reviewed source. Backend activation remains a separate exact-approval step.
