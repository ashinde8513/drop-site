...
- **Register:** product — the **browse-first discovery website** (AXS-style; see `AXS_MODEL.md`), NOT a marketing landing. Content is the hero; browser login/app shell routes are retired in favor of the native app.
