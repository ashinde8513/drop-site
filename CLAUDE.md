...
- **Register:** product — the **pre-login browse-first discovery site** (AXS-style; see `AXS_MODEL.md`), NOT a marketing landing. Content is the hero; the signed-in app lives at `/app`.
