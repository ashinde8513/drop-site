...
- **One Prism across surfaces.** The website and native app share identity, data, wordmark, shell language, and cards, but they remain separate products: website for open discovery, native app for accounts.
