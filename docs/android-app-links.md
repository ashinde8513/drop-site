...
Source readiness does not mean device readiness. A Play-signed installable internal release does not exist yet, so physical App Links acceptance remains blocked until that separate build and Play Internal Testing release is available.
