...
## 2026-07-12 session (latest) — account.html retired + round-4 port: logged-in web = Prism SPA (LIVE, deploys `d8fb2117`→`1e5712a6` + worker `c650cc64`)
