...
- **Verified/boundary:** Node 8/8, desktop/mobile Playwright 180/180, syntax/build parity/diff checks, and independent adversarial re-review pass. Browser tests cover first-touch overwrite/expiry and old-account rejection. No migration, deploy, secret, production write, PR, or public release occurred.
