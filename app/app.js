  ...
  renderVals(){
    ...
    const LEGAL = {
      privacy: { kicker:'LEGAL · PRIVACY', title:'Privacy Policy', body:[
        ...
        {h:'Public artist data', t:'When other suitable artwork is unavailable, Drop may use a selected artist\'s public SoundCloud profile identifier, profile URL, username, and avatar as fallback art. SoundCloud images remain hosted by SoundCloud, are credited and linked to the source profile, and are cached on your device only in memory for the current session. Drop periodically refreshes reviewed mappings, removes unavailable images, and can purge retained SoundCloud identifiers, profile links, and fallback images when access is revoked or a valid removal request is received.'},
