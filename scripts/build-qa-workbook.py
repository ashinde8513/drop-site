...
TEST_RUNS = [
    ...
    ["RUN-024", AUDIT_DATE, "website 7162be246177b646ff7c28dc4b0fec004d7e1e0f; mobile 21ce9b618979f298374d21c232bb3e04f92d7e6b", "Authorized Drop-App merge + owner-only Sites v12 deploy + live browser/access/log and corrected runtime verification", "Passed / pre-build boundary corrected by RUN-027", "PR #290 exact head 16f9463 merged with a merge commit; main and release-train-31-21ce9b6 resolve to 21ce9b6; release-train, closeout, and tagged web-deploy passed. Sites v12 exact source 7162be2 deployed with custom access only for ashinde8513@gmail.com. Desktop/mobile event, combobox, Profile/Stats/history, console/page-error, and Worker-error checks passed. The earlier a904ccc60ecf3ff7ab907769b1cdfc7281592806 preflight value was not generated with the exact tag's locked dependency tree and is superseded by RUN-027's post-npm-ci d42ed9dc7445172d9d0ca08124fd0443d0eaa433 fingerprint."],
    ...
    ["RUN-027", "2026-07-30", "21ce9b618979f298374d21c232bb3e04f92d7e6b", "production-release run 30520238695 build-and-submit + EAS build/submission readback + Apple TestFlight availability", "Passed / physical-device QA pending", "Exact tag release-train-31-21ce9b6 produced EAS Build 0cc12512-5999-4c40-b595-671ac2991a9a, iOS 1.0.1 (16), production/store/channel production, runtime d42ed9dc7445172d9d0ca08124fd0443d0eaa433, exact source 21ce9b6. Submission 914d5987-682d-42ff-bb35-388a199926cb finished with no error, and Apple confirmed Build 16 is available to test at 2026-07-30T06:51:01Z. No OTA, external TestFlight access change, or App Store production release occurred."],
    ["RUN-028", "2026-07-30", "b2b1b53d488561d171838eebc69d5d464a1aa739", "release evidence/workbook validation + typecheck + build + full Playwright suite", "Passed with existing bundle warning", "Generator validation passed twice with identical XLSX hashes; all ZIP/XML members parsed and the Feature Matrix sheet equaled all 677 CSV rows. TypeScript passed; Vite built 169 modules with the tracked >500 kB warning; Sites preview plus Playwright passed 295 with 1 intentional skip across desktop Chromium and mobile WebKit in 2.1 minutes. The initial restricted npm test attempt stopped before Playwright because its local web server could not start; the approved local-server rerun passed."],
]
